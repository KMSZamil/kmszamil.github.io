  ...
  <header id="header">
    <div class="d-flex flex-column">
      ...
      <div class="profile">
        ...
        <h1 class="text-light"><a href="{{asset('')}}/index.html">Alex Smith</a></h1>
        <div class="social-links mt-3 text-center">
          <a href="{{asset('')}}/#" class="twitter"><i class="bx bxl-twitter"></i></a>
          <a href="{{asset('')}}/#" class="facebook"><i class="bx bxl-facebook"></i></a>
          <a href="{{asset('')}}/#" class="instagram"><i class="bx bxl-instagram"></i></a>
          <a href="{{asset('')}}/#" class="google-plus"><i class="bx bxl-skype"></i></a>
          <a href="{{asset('')}}/#" class="linkedin"><i class="bx bxl-linkedin"></i></a>
        </div>
      </div>

      <nav id="navbar" class="nav-menu navbar">
        <ul>
          <li><a href="{{asset('')}}/#hero" class="nav-link scrollto active"><i class="bx bx-home"></i> <span>Home</span></a></li>
          <li><a href="{{asset('')}}/#about" class="nav-link scrollto"><i class="bx bx-user"></i> <span>About</span></a></li>
          <li><a href="{{asset('')}}/#resume" class="nav-link scrollto"><i class="bx bx-file-blank"></i> <span>Resume</span></a></li>
          <li><a href="{{asset('')}}/#portfolio" class="nav-link scrollto"><i class="bx bx-book-content"></i> <span>Portfolio</span></a></li>
          <li><a href="{{asset('')}}/#services" class="nav-link scrollto"><i class="bx bx-server"></i> <span>Services</span></a></li>
          <li><a href="{{asset('')}}/#contact" class="nav-link scrollto"><i class="bx bx-envelope"></i> <span>Contact</span></a></li>
        </ul>
      </nav><!-- .nav-menu -->
    </div>
  </header><!-- End Header -->
