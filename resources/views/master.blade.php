...
<body>
    ...
    <header id="header">
        <div class="d-flex flex-column">
            ...
            <div class="profile">
                ...
                <h1 class="text-light"><a href="{{ url('/') }}">K. M. Shawkat Zamil</a></h1>
    ...
    <section id="hero" class="d-flex flex-column justify-content-center align-items-center">
        <div class="hero-container" data-aos="fade-in">
            <h1>K. M. Shawkat Zamil</h1>
            <p>I'm <span class="typed"
                    data-typed-items="Engineer, Developer, Freelancer, Problem Solver, Project Lead"></span></p>
        </div>
    </section><!-- End Hero -->
        ...
        <section id="about" class="about">
            <div class="container">
                ...
                <div class="section-title">
                    <h2>About</h2>
                    <p>I am a seasoned IT professional with a strong background in PHP programming language, ReactJs,
                        VueJs, Laravel, and expertise in both MySQL and MSSQL Server databases. With a proven track
                        record of delivering high-quality web solutions, I have successfully led and contributed to
                        numerous projects throughout my career. My proficiency in PHP and Laravel allows me to architect
                        robust and scalable web applications, while my skills in ReactJs and VueJs enhance user
                        interfaces with dynamic and responsive features.
                    </p>
                </div>

                <div class="row">
                    <div class="col-lg-4" data-aos="fade-right">
                        <img src="{{ asset('assets/img/profile-img.jpg') }}" class="img-fluid" alt="profile-image">
                    </div>
                    <div class="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
                        <h3>Senior Software Engineer</h3>
                        <p class="fst-italic">
                            In addition to my technical expertise, I bring valuable leadership experience to the table.
                            I have successfully served as a team lead, overseeing and coordinating project teams to
                            achieve project goals efficiently and within established timelines. My ability to
                            communicate effectively with both technical and non-technical stakeholders has played a
                            ...
                            <div class="col-lg-6">
                                <ul>
                                    ...
                                    <li><i class="bi bi-chevron-right"></i> <strong>Address:</strong>
                                        <span>248/1 East Goran, Dhaka 1219</span>
                                    </li>

                                    <li><i class="bi bi-chevron-right"></i> <strong>Blood Group:</strong>
                                        <span>O+</span>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div class="portfolio-links">
                                <a href="{{ asset('') }}/assets/img/portfolio/portfolio-2.jpg"
                                    data-gallery="portfolioGallery" class="portfolio-lightbox" title="Web 3"><i
                                        class="bx bx-plus"></i></a>
                                <a href="{{ asset('') }}/portfolio-details.html" title="More Details"><i
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 icon-box" data-aos="fade-up">
                        ...
                        <h4 class="title"><a href="{{ asset('') }}/">Lorem Ipsum</a></h4>
                        <p class="description">Voluptatum deleniti atque corrupti quos dolores et quas molestias
                            excepturi sint occaecati cupiditate non provident</p>
                    </div>
                    <div class="col-lg-4 col-md-6 icon-box" data-aos="fade-up" data-aos-delay="100">
                        <div class="icon"><i class="bi bi-card-checklist"></i></div>
                        <h4 class="title"><a href="{{ asset('') }}/">Dolor Sitema</a></h4>
                        <p class="description">Minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip
                            ex ea commodo consequat tarad limino ata</p>
                    </div>
                    <div class="col-lg-4 col-md-6 icon-box" data-aos="fade-up" data-aos-delay="200">
                        <div class="icon"><i class="bi bi-bar-chart"></i></div>
                        <h4 class="title"><a href="{{ asset('') }}/">Sed ut perspiciatis</a></h4>
                        <p class="description">Duis aute irure dolor in reprehenderit in voluptate velit esse cillum
                            dolore eu fugiat nulla pariatur</p>
                    </div>
                    <div class="col-lg-4 col-md-6 icon-box" data-aos="fade-up" data-aos-delay="300">
                        <div class="icon"><i class="bi bi-binoculars"></i></div>
                        <h4 class="title"><a href="{{ asset('') }}/">Magni Dolores</a></h4>
                        <p class="description">Excepteur sint occaecat cupidatat non proident, sunt in culpa qui
                            officia deserunt mollit anim id est laborum</p>
                    </div>
                    <div class="col-lg-4 col-md-6 icon-box" data-aos="fade-up" data-aos-delay="400">
                        <div class="icon"><i class="bi bi-brightness-high"></i></div>
                        <h4 class="title"><a href="{{ asset('') }}/">Nemo Enim</a></h4>
                        <p class="description">At vero eos et accusamus et iusto odio dignissimos ducimus qui
                            blanditiis praesentium voluptatum deleniti atque</p>
                    </div>
                    <div class="col-lg-4 col-md-6 icon-box" data-aos="fade-up" data-aos-delay="500">
                        <div class="icon"><i class="bi bi-calendar4-week"></i></div>
                        <h4 class="title"><a href="{{ asset('') }}/">Eiusmod Tempor</a></h4>
    ...
    <a href="{{ asset('') }}/#" class="back-to-top d-flex align-items-center justify-content-center"><i
